...
<meta name="apple-mobile-web-app-status-bar-style" content="black">
    ...
    <body id="jqt" class="supports3d portrait">
        <div id="home" class="current" style="min-height: 624px; ">
            <div class="toolbar" align=center background=white>
			<img src=artimage/img/logo_artimage_pq42.png>
			<a class="button back" href="index.html">Voltar</a>
		</div>
            <ul class="edgetoedge">
                <li class="arrow"><a href="download/ArtImageApp.apk">App Android</a></li>
            	<li class="arrow"><a href="HelloCordova.apk">App iOS</a></li>
             </ul>
        </div>
